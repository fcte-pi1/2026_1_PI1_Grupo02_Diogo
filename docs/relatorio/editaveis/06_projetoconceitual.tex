...
A Figura~\ref{fig:desenhos_carrinho} apresenta as vistas lateral, superior, frontal e isométrica do carrinho, com suas medidas gerais.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figuras/desenhos-carrinho.pdf}
    \caption{Desenhos técnicos do carrinho com vistas e medidas gerais.}
    \label{fig:desenhos_carrinho}
\end{figure}
